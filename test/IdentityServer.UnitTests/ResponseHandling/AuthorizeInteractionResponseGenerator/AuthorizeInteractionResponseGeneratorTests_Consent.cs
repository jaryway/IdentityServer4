...
namespace IdentityServer.UnitTests.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    ...
    {
        private Jaryway.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
        ...
        {
            _subject = new Jaryway.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator(
                new StubClock(),
                TestLogger.Create<Jaryway.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator>(),
                _mockConsent,
                _fakeUserService);
        }
