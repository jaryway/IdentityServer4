...
namespace IdentityServer.UnitTests.Endpoints.Results
{
    public class AuthorizeResultTests
    {
        ...
        private MockMessageStore<Jaryway.IdentityServer.Models.ErrorMessage> _mockErrorMessageStore = new MockMessageStore<Jaryway.IdentityServer.Models.ErrorMessage>();
