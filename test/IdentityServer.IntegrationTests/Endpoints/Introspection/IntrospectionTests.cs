...
namespace IdentityServer.IntegrationTests.Endpoints.Introspection
{
    public class IntrospectionTests
    {
        ...
        public async Task Response_data_should_be_valid_using_single_scope()
        {
            ...
            var values = JsonSerializer.Deserialize<Dictionary<string, JsonElement>>(introspectionResponse.Json.ToString());
        ...
        public async Task Response_data_should_be_valid_using_multiple_scopes_multiple_audiences()
        {
            ...
            var values = JsonSerializer.Deserialize<Dictionary<string, JsonElement>>(introspectionResponse.Json.Value.GetRawText());
        ...
        public async Task Response_data_should_be_valid_using_multiple_scopes_single_audience()
        {
            ...
            var values = JsonDocument.Parse(introspectionResponse.Json.ToString()).Deserialize<Dictionary<string, JsonElement>>();
