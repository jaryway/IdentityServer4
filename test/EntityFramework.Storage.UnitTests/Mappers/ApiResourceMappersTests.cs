...
using Xunit;
using ApiResource = Jaryway.IdentityServer.Models.ApiResource;

namespace Jaryway.IdentityServer.EntityFramework.UnitTests.Mappers
{
    public class ApiResourceMappersTests
    {
        ...
        {
            var entity = new Jaryway.IdentityServer.EntityFramework.Entities.ApiResource
            {
