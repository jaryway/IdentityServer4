...
using Jaryway.IdentityServer.EntityFramework.Extensions;
using Jaryway.IdentityServer.EntityFramework.Interfaces;
using Jaryway.IdentityServer.EntityFramework.Options;
using Microsoft.EntityFrameworkCore;

namespace Jaryway.IdentityServer.EntityFramework.DbContexts
{
    /// <summary>
    /// DbContext for the IdentityServer operational data.
    /// </summary>
    /// <seealso cref="Microsoft.EntityFrameworkCore.DbContext" />
    /// <seealso cref="Jaryway.IdentityServer.EntityFramework.Interfaces.IPersistedGrantDbContext" />
