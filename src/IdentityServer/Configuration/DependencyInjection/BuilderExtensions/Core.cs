...
using Jaryway.IdentityServer.Configuration.DependencyInjection;
using Jaryway.IdentityServer.Endpoints;
...
using Jaryway.IdentityServer.Hosting.FederatedSignOut;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensionsCore
    {
            ...
            where T : class, IEndpointHandler
        {
            ...
            builder.Services.AddSingleton(new Jaryway.IdentityServer.Hosting.Endpoint(name, path, typeof(T)));
